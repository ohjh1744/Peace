...
public class GameManager : MonoBehaviour
{
    ...
    string[] Npc16_talk = new string[37];
    string[] Npc17_talk = new string[14];
    string[] Npc18_talk = new string[14];
    string[] Npc20_talk = new string[20];
    ...
    void Awake()
    {
        ...
        Npc16_talk[20] = "지나: ...";
        Npc16_talk[21] = "지나: 복수 꼭 부탁드리겠습니다...";
        Npc16_talk[22] = "지나: 위치만 알려주세요. 저희가 시간 되는대로 빠르게 가겠습니다.";
        Npc16_talk[23] = "지나: 저희 동료는 적어도 마지막은 저희가 챙겨주겠습니다.";
        Npc16_talk[24] = "주인공: 네... 곧 바로 알려드리겠습니다.";
        Npc16_talk[25] = "지나: 네... 감사합니다. 다음에 도움이 필요하면 언제든지 연락주세요.";
        Npc16_talk[26] = "주인공: 네 또 연락드리죠.";
        Npc16_talk[27] = "주인공: ...";
        Npc16_talk[28] = "주인공: 음? 잠시만 손에 뭐가 있어...";
        Npc16_talk[29] = "주인공: 죽기 전에 미리 메시지를 남겼구나...";
        Npc16_talk[30] = "주인공: 마을 중앙 우물...";
        Npc16_talk[31] = "주인공: 북... 동...";
        Npc16_talk[32] = "주인공: 역 ㄱ자 뒤에서 접선...";
        Npc16_talk[33] = "주인공: 장소를 의미하는거 같은데?";
        Npc16_talk[34] = "주인공: 27일이면 오늘인데..";
        Npc16_talk[35] = "주인공: 8시면 곧이군.";
        Npc16_talk[36] = "주인공: 일단 이쪽으로 빠르게 가봐야겠어.";
        ...
        Npc20_talk[15] = "자객: 마을 오른 쪽길로 가다보면 알 수 있을거야.";
        Npc20_talk[16] = "자객: 가는 길이 경비가 삼엄하니까 조심하는게 좋을거고...";
        Npc20_talk[17] = "자객: 이게 내가 아는 전부야...";
        Npc20_talk[18] = "주인공: (일단 이 자객놈이 말한대로 실험 하는 곳으로 가보자.)";
        Npc20_talk[19] = "주인공: (그 곳으로 가면 어떤 실험을 하고 있는지, 무슨 일을 벌이고 있는지 알 수 있을거야.)";

        Player_monologue_3[0] = "주인공: 확실히 그 놈말대로 경비가 많아.";
        ...
        Npc21_talk[2] = "카이만: ...크크크 돈? 그딴 것 보다 큰 계획을 위해서지.";
        ...
        Npc13_talk_2[20] = "이장: 그 길을 따라 바다 안으로 들어가면 오션 시티라는 곳이 있다네.";
        Npc13_talk_2[21] = "이장: 바다 내부에 있는 도시지.";
